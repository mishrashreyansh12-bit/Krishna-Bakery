...
const PRODUCTS = [
  ...
  // ── Luxe Collection ──
  { id:10, name:"Cocoa Hazelnut Mousse",       category:"Luxe Collection",  priceINR:2499, priceUSD:29.99, tag:"Luxe",        desc:"Eggless mousse with praline crunch. Premium gifting.",      image:"https://images.unsplash.com/photo-1606890737304-57a1ca8a5b62?auto=format&fit=crop&q=90&w=800" },
  ...
  { id:27, name:"Gold Leaf Opera Cake",        category:"Luxe Collection",  priceINR:1899, priceUSD:22.79, tag:"Luxe",        desc:"Coffee buttercream, almond joconde, edible gold leaf.",     image:"https://images.unsplash.com/photo-1578985545062-69928b1d9587?auto=format&fit=crop&q=90&w=800" },
  { id:28, name:"Rose Pistachio Entremet",     category:"Luxe Collection",  priceINR:2199, priceUSD:26.39, tag:"Luxe",        desc:"Rose mousse, pistachio dacquoise, mirror glaze.",           image:"https://images.unsplash.com/photo-1488477181946-6428a0291777?auto=format&fit=crop&q=90&w=800" },
  ...
  { id:29, name:"Chocolate Sprinkle Donut",    category:"Donuts",           priceINR:90,   priceUSD:1.08,  tag:"Trending",    desc:"Chocolate dipped with rainbow sprinkles.",                  image:"https://images.unsplash.com/photo-1551024601-bec78aea704b?auto=format&fit=crop&q=90&w=800" },
  { id:30, name:"Cinnamon Sugar Donut",        category:"Donuts",           priceINR:70,   priceUSD:0.84,  tag:"Classic",     desc:"Warm cinnamon sugar coating on a fluffy base.",             image:"https://images.unsplash.com/photo-1551024601-bec78aea704b?auto=format&fit=crop&q=90&w=800" },
  { id:31, name:"Strawberry Jam Donut",        category:"Donuts",           priceINR:85,   priceUSD:1.02,  tag:"Bestseller",  desc:"Filled with house-made strawberry jam. Dusted with sugar.", image:"https://images.unsplash.com/photo-1551024601-bec78aea704b?auto=format&fit=crop&q=90&w=800" },
  ...
  { id:32, name:"Red Velvet Cupcake",          category:"Cupcakes",         priceINR:130,  priceUSD:1.56,  tag:"Bestseller",  desc:"Cream cheese frosting on a classic red velvet base.",       image:"https://images.unsplash.com/photo-1607478900766-efe13248b125?auto=format&fit=crop&q=90&w=800" },
  { id:33, name:"Salted Caramel Cupcake",      category:"Cupcakes",         priceINR:140,  priceUSD:1.68,  tag:"Chef's Pick", desc:"Caramel buttercream with a salted caramel drizzle.",        image:"https://images.unsplash.com/photo-1607478900766-efe13248b125?auto=format&fit=crop&q=90&w=800" },
  { id:34, name:"Lemon Meringue Cupcake",      category:"Cupcakes",         priceINR:135,  priceUSD:1.62,  tag:"Seasonal",    desc:"Lemon curd centre, toasted meringue topping.",              image:"https://images.unsplash.com/photo-1607478900766-efe13248b125?auto=format&fit=crop&q=90&w=800" },
  ...
  { id:35, name:"Almond Croissant",            category:"Viennoiserie",     priceINR:160,  priceUSD:1.92,  tag:"Chef's Pick", desc:"Twice-baked with almond cream and flaked almonds.",         image:"https://images.unsplash.com/photo-1555507036-ab1f4038808a?auto=format&fit=crop&q=90&w=800" },
  { id:36, name:"Kouign-Amann",                category:"Viennoiserie",     priceINR:180,  priceUSD:2.16,  tag:"Artisan",     desc:"Caramelised Breton pastry. Crispy, buttery, flaky.",        image:"https://images.unsplash.com/photo-1555507036-ab1f4038808a?auto=format&fit=crop&q=90&w=800" },
  ...
  { id:37, name:"Double Choco Chip Cookie",    category:"Cookies",          priceINR:70,   priceUSD:0.84,  tag:"Bestseller",  desc:"Two types of chocolate chips in a chewy base.",             image:"https://images.unsplash.com/photo-1558961363-fa8fdf82db35?auto=format&fit=crop&q=90&w=800" },
  { id:38, name:"Oatmeal Raisin Cookie",       category:"Cookies",          priceINR:55,   priceUSD:0.66,  tag:"Classic",     desc:"Hearty oats, plump raisins, warm cinnamon.",                image:"https://images.unsplash.com/photo-1558961363-fa8fdf82db35?auto=format&fit=crop&q=90&w=800" },
  { id:39, name:"Matcha White Choco Cookie",   category:"Cookies",          priceINR:80,   priceUSD:0.96,  tag:"Trending",    desc:"Japanese matcha with white chocolate chunks.",              image:"https://images.unsplash.com/photo-1558961363-fa8fdf82db35?auto=format&fit=crop&q=90&w=800" },
  ...
  { id:40, name:"Walnut Brownie",              category:"Brownies",         priceINR:100,  priceUSD:1.20,  tag:"Classic",     desc:"Fudge brownie loaded with crunchy California walnuts.",     image:"https://images.unsplash.com/photo-1606313564200-e75d5e30476c?auto=format&fit=crop&q=90&w=800" },
  { id:41, name:"Cream Cheese Brownie",        category:"Brownies",         priceINR:110,  priceUSD:1.32,  tag:"Chef's Pick", desc:"Swirled cream cheese on a fudge brownie base.",             image:"https://images.unsplash.com/photo-1606313564200-e75d5e30476c?auto=format&fit=crop&q=90&w=800" },
  { id:42, name:"Salted Caramel Brownie",      category:"Brownies",         priceINR:115,  priceUSD:1.38,  tag:"Trending",    desc:"Sea salt flakes and caramel swirl on dark chocolate.",      image:"https://images.unsplash.com/photo-1606313564200-e75d5e30476c?auto=format&fit=crop&q=90&w=800" },
  ...
  { id:43, name:"Multigrain Loaf",             category:"Breads",           priceINR:160,  priceUSD:1.92,  tag:"Healthy",     desc:"Seeds, grains, and whole wheat. Nutritious & hearty.",      image:"https://images.unsplash.com/photo-1586444248902-2f64eddc13df?auto=format&fit=crop&q=90&w=800" },
  { id:44, name:"Focaccia with Rosemary",      category:"Breads",           priceINR:200,  priceUSD:2.40,  tag:"Artisan",     desc:"Olive oil, sea salt, fresh rosemary. Italian classic.",     image:"https://images.unsplash.com/photo-1586444248902-2f64eddc13df?auto=format&fit=crop&q=90&w=800" },
  { id:45, name:"Cinnamon Raisin Bread",       category:"Breads",           priceINR:170,  priceUSD:2.04,  tag:"Classic",     desc:"Soft enriched dough with cinnamon swirl and raisins.",      image:"https://images.unsplash.com/photo-1586444248902-2f64eddc13df?auto=format&fit=crop&q=90&w=800" },
  ...
  { id:46, name:"Cardamom Honey Cake",         category:"Tea Cakes",        priceINR:320,  priceUSD:3.84,  tag:"Artisan",     desc:"Warm cardamom spice with a honey drizzle finish.",          image:"https://images.unsplash.com/photo-1464349095431-e9a21285b5f3?auto=format&fit=crop&q=90&w=800" },
  { id:47, name:"Orange Poppy Seed Cake",      category:"Tea Cakes",        priceINR:300,  priceUSD:3.60,  tag:"Classic",     desc:"Zesty orange zest with crunchy poppy seeds.",               image:"https://images.unsplash.com/photo-1464349095431-e9a21285b5f3?auto=format&fit=crop&q=90&w=800" },
  { id:48, name:"Chai Spice Loaf",             category:"Tea Cakes",        priceINR:280,  priceUSD:3.36,  tag:"Trending",    desc:"Masala chai spices baked into a moist loaf cake.",          image:"https://images.unsplash.com/photo-1464349095431-e9a21285b5f3?auto=format&fit=crop&q=90&w=800" },
];
...
export default function Collection({ onProductClick }) {
  ...
  const CATEGORIES = ["All", "Signature Cakes", "Luxe Collection", "Donuts", "Cupcakes", "Viennoiserie", "Cookies", "Brownies", "Breads", "Tea Cakes"];
  ...
  return (
    <section id="collection" className="py-28 overflow-hidden"
      style={{ background: "linear-gradient(180deg, #080604 0%, #0c0a06 100%)" }}>
          ...
          {[
            ...
            <motion.div key={f.title}
              ...
              <p className="text-sm font-semibold text-white mb-1"
                style={{ fontFamily: "'Playfair Display', serif" }}>{f.title}</p>
              <p className="text-[11px]" style={{ color: "rgba(255,255,255,0.35)" }}>{f.sub}</p>
            </motion.div>
          ))}
        </div>
