    ...
    >
      ...
      <motion.div ref={bgRef} className="absolute inset-0">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to right, var(--bg) 35%, rgba(28,22,18,0.7) 60%, rgba(28,22,18,0.2) 100%)",
          }}
        />
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to bottom, rgba(28,22,18,0.5) 0%, transparent 30%, rgba(28,22,18,0.9) 100%)",
          }}
        />
        ...
        <motion.div
          ...
          style={{
            ...
            right: "10%",
            background:
              "radial-gradient(ellipse, rgba(212,168,67,0.08) 0%, transparent 70%)",
            filter: "blur(50px)",
          }}
          animate={{ opacity: [0.4, 0.9, 0.4] }}
          transition={{
      ...
      >
        {/* eyebrow */}
        <div
          className="h-eyebrow flex items-center gap-3 mb-7"
          style={{ opacity: 0 }}
        >
          <AnimatePresence mode="wait">
            <motion.span
          ...
          <div
            className="h-px w-10"
            style={{
              background: `linear-gradient(to right, ${current.accent}60, transparent)`,
            }}
          />
        ...
        {/* ── Single H1 containing both animated headline lines ── */}
        <h1 className="mb-8">
          <span
            className="h-line1 block overflow-hidden text-[clamp(2.8rem,8vw,8.5rem)] font-light leading-[0.88]"
            style={{
              fontFamily: "'Playfair Display', serif",
          ...
          <span
            className="h-line2 block overflow-hidden text-[clamp(2.8rem,8vw,8.5rem)] font-bold leading-[0.88] italic"
            style={{
              fontFamily: "'Playfair Display', serif",
              letterSpacing: "-0.03em",
              opacity: 0,
              background:
                "linear-gradient(135deg, #D4A843 0%, #F0CC6E 50%, #A67C1A 100%)",
              WebkitBackgroundClip: "text",
              WebkitTextFillColor: "transparent",
              backgroundClip: "text",
            }}
        ...
        {/* CTAs */}
        <div
          className="h-cta flex flex-wrap items-center gap-3"
          style={{ opacity: 0 }}
        >
          <motion.button
            whileHover={{
        ...
        {/* stats */}
        <div
          className="flex flex-wrap items-center gap-6 md:gap-10 mt-10 md:mt-14 pt-6 md:pt-8"
          style={{
            borderTop: "1px solid rgba(242,232,217,0.07)",
          }}
        >
          {[
            ["500+", t.heroStatCustomers],
            ["50+", t.heroStatItems],
            ["4.9★", t.heroStatRating],
            ["6+", t.heroStatYears],
          ].map(([n, l]) => (
            <div key={l} className="h-stat" style={{ opacity: 0 }}>
              <p
                ...
                style={{
                  background:
                    "linear-gradient(135deg, #D4A843, #F0CC6E)",
                  WebkitBackgroundClip: "text",
                  WebkitTextFillColor: "transparent",
                  backgroundClip: "text",
                }}
      ...
      >
        <motion.div
          ...
          className="w-5 h-8 rounded-full border flex items-start justify-center pt-1.5"
          style={{
            borderColor: "rgba(242,232,217,0.15)",
          }}
        >
          <div
